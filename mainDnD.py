...
gdbEntry.drop_target_register(DND_FILES)
def dnd(entry,data):
	entry.delete(0,tkinter.END)
	entry.insert(tkinter.END,data)
	entry.xview_moveto(1)
gdbEntry.dnd_bind('<<Drop>>', lambda e: dnd(gdbEntry,e.data))
...
xslxEntry.drop_target_register(DND_FILES)
xslxEntry.dnd_bind('<<Drop>>', lambda e: dnd(xslxEntry,e.data))
...
import os
reportEntry.insert(tkinter.END,os.getcwd())
reportEntry.xview_moveto(1)
